(* OASIS_START *)
(* DO NOT EDIT (digest: dadba36db80c49a2856e1c8fe3bf6aff) *)
...
let package_default =
  {
     MyOCamlbuildBase.lib_ocaml = [("macaque_lwt", ["src"])];
     lib_c = [];
     flags =
       [
          (["oasis_library_macaque_lwt_byte"; "ocaml"; "link"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "A"])]);
          (["oasis_library_macaque_lwt_native"; "ocaml"; "link"; "native"],
            [(OASISExpr.EBool true, S [A "-w"; A "A"])]);
          (["oasis_library_macaque_lwt_byte"; "ocaml"; "ocamldep"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "A"])]);
          (["oasis_library_macaque_lwt_native"; "ocaml"; "ocamldep"; "native"
           ],
            [(OASISExpr.EBool true, S [A "-w"; A "A"])]);
          (["oasis_library_macaque_lwt_byte"; "ocaml"; "compile"; "byte"],
            [(OASISExpr.EBool true, S [A "-w"; A "A"])]);
          (["oasis_library_macaque_lwt_native"; "ocaml"; "compile"; "native"],
            [(OASISExpr.EBool true, S [A "-w"; A "A"])])
       ];
     includes = [];
     }
